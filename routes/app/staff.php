...
use App\Http\Controllers\Staff\DataPenilaiController;
use App\Http\Controllers\Staff\ProfileController;
use App\Http\Controllers\Staff\SurveyController;
...
Route::group(['domain' => ''], function () {
    ...
    Route::prefix('staff')->name('staff.')->group(function () {
        ...
        Route::group(['middleware' => ['auth:staff', 'verified']], function () {
            ...
            Route::resource('assign-penilai', DataPenilaiController::class);
