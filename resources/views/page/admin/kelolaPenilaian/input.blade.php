            ...
            <div class="card-body p-9">
                ...
                <form id="form_input">
                    <div class="row mb-7">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="mb-10">
                                <label for="kategori" class="required form-label">Jenis</label>
                                <select class="form-select" name="jenis">
                                    <option value="akademik" {{$kelolaPenilaian->jenis == "akademik" ? 'selected' : ''}}>Akademik</option>
                                    <option value="non_akademik" {{$kelolaPenilaian->jenis == "non_akademik" ? 'selected' : ''}}>Non Akademik</option>
                                </select>
                            </div>
                        </div>
