<x-app-layout title="Data Survey">
    <!--begin::Search form-->
    <div id="content_list">
        <div class="card rounded-0 bgi-no-repeat bgi-position-x-end bgi-size-cover" style="background-color: #3C8DBC;background-size: auto 100%; background-image: url({{asset('keenthemes/media/misc/taieri.svg')}})">
            ...
            <div class="card-body container pt-10 pb-8">
                ...
                <div class="d-flex align-items-center">
                    <h1 class="fw-bold me-3 text-white">Data Survey</h1>
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-lg-flex align-lg-items-center">
                        ...
                        <!--begin::Action-->
                        <div class="d-flex align-items-center">
                            <a class="btn btn-active-color-danger" href="javascript:;" onclick="load_input('{{route('admin.staff.create')}}');">Tambah Data</a>
                        </div>
                        <!--end::Action-->
                    </div>
                    <!--end::Block-->
                    ...
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-sm-12 col-md-12">
                                {{-- <p class="fs-6 fw-bold text-gray-700 mb-3">Rata-Rata Hasil Survey Penilaian : {{$surveyPenilaian}}</p> --}}
                                <a href="{{route('admin.request_download_excel')}}" class="btn btn-primary">Export Data</a>
